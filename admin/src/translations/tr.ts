...
export default {
  ...
  'compontents.confirmation.dialog.header': 'Onayla',
  'compontents.confirmation.dialog.description': 'Bu eylemi gerçekleştirmek istediğinize emin misiniz?',
  'compontents.confirmation.dialog.button.confirm': 'Eminim',
  'compontents.confirmation.dialog.button.cancel': 'İptal et',
  'compontents.toogle.enabled': 'Aktif',
  'compontents.toogle.disabled': 'Deaktif',
  'compontents.author.unknown': 'Yazar kaldırıldı',
