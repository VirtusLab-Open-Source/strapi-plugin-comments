...
export default {
  ...
  'compontents.confirmation.dialog.header': '确认书',
  'compontents.confirmation.dialog.description': '您真的要执行此操作吗？',
  'compontents.confirmation.dialog.button.confirm': '确定',
  'compontents.confirmation.dialog.button.cancel': '取消',
  'compontents.toogle.enabled': '启用',
  'compontents.toogle.disabled': '禁用',
  'compontents.author.unknown': '作者已删除',
