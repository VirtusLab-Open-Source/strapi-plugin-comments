...
export default {
  ...
  'compontents.confirmation.dialog.header': 'Подтверждение',
  'compontents.confirmation.dialog.description': 'Вы действительно подтверждаете действие?',
  'compontents.confirmation.dialog.button.confirm': 'Да, подтверждаю',
  'compontents.confirmation.dialog.button.cancel': 'Отмена',
  'compontents.toogle.enabled': 'Включено',
  'compontents.toogle.disabled': 'Отключено',
  'compontents.author.unknown': 'Автор удален',
