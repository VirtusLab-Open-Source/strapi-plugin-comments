    ...
    <>
      <SubNav aria-label="Comments sub nav" display={{ initial: 'none', large: 'block' }}>
        ...
        <SubNavSections>
          <SubNavSection label={getMessage('nav.header.moderation')}>
            <SubNavLink tag={NavLink} to="/plugins/@alfanet-technologies/strapi-plugin-comments/discover">
              {getMessage('nav.item.discover')}
            </SubNavLink>
            <SubNavLink to="/plugins/@alfanet-technologies/strapi-plugin-comments/reports" tag={NavLink} withBullet={false}>
      ...
      >
        <Flex
          ...
          gap={2}
        >
          <Link tag={NavLink} to="/plugins/@alfanet-technologies/strapi-plugin-comments/discover">
            {getMessage('nav.item.discover')}
          </Link>
          <Link tag={NavLink} to="/plugins/@alfanet-technologies/strapi-plugin-comments/reports">
            {getMessage('nav.item.reports')}
          </Link>
        </Flex>
      </Box>
