...
export type PluginConfigKeys = 'enabledCollections' | 'approvalFlow' | 'entryLabel' | 'moderatorRoles' | 'badWords' | 'reportReasons';
...
export type ViewCommentsPluginConfig = Pick<CommentsPluginConfig, PluginConfigKeysEnum.APPROVAL_FLOW | PluginConfigKeysEnum.ENTRY_LABEL | PluginConfigKeysEnum.REPORT_REASONS> & {
